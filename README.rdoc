...
== Usage
  ...
  # edge detection for PNG files
  image = ChunkyPNG::Image.from_file('original.png')
  edge_detected_image = image.edge_detect_with(:sobel) # default, :prewitt also available

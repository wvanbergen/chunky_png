...
describe ChunkyPNG::Canvas::PNGEncoding do
  ...
  describe 'different color modes and bit depths' do
    ...
    it "should encode using 8-bit RGBA mode correctly" do
      ...
      stream.should == binary_string("\0\x01\x02\x03\x04\xFC\xFD\xFE\xFF\0\xFF\xFE\xFD\xFC\x04\x03\x02\x01")
    end
    ...
    it "should encode using 8 bit RGB mode correctly" do
      ...
      stream.should == binary_string("\0\x01\x02\x03\xFC\xFD\xFE\0\xFF\xFE\xFD\x04\x03\x02")
    end
    ...
    it "should encode using 1-bit grayscale mode correctly" do
      ...
      stream.should == binary_string("\0\x40\0\x80") # Using the B byte of the pixel == 3, assuming R == G == B for grayscale images
    end
    ...
    it "should encode using 2-bit grayscale mode correctly" do
      ...
      stream.should == binary_string("\0\x30\0\xC0") # Using the B byte of the pixel == 3, assuming R == G == B for grayscale images
    end
    ...
    it "should encode using 4-bit grayscale mode correctly" do
      ...
      stream.should == binary_string("\0\x0F\0\xF0") # Using the B byte of the pixel == 3, assuming R == G == B for grayscale images
    end
    ...
    it "should encode using 8-bit grayscale mode correctly" do
      ...
      stream.should == binary_string("\0\x03\xFE\0\xFD\x02") # Using the B byte of the pixel == 3, assuming R == G == B for grayscale images
    end
    ...
    it "should encode using 2-bit indexed mode correctly" do
      ...
      stream.should == binary_string("\0\x20\0\xD0")
    end
    ...
    it "should encode using 4-bit indexed mode correctly" do
      ...
      stream.should == binary_string("\0\x02\0\x31")
    end
    ...
    it "should encode using 8-bit indexed mode correctly" do
      ...
      stream.should == binary_string("\0\x00\x02\0\x03\x01")
    end
  end
